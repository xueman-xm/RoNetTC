...
class MaskedModel:
    ...
    def __init__(self, model, masker, link, linearize_link, *args):
        ...
        print("Debugging MaskedModel initialization!")
        print("Debugging self.args:")
        for i, a in enumerate(args):
            print(f"args[{i}]: Type={type(a)}, Content={a if isinstance(a, int) else 'Tensor or Other'}")
